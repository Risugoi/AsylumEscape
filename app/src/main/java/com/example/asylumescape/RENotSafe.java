...
public class RENotSafe extends AppCompatActivity {
    DatabaseHelper db;
    MediaPlayer mp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_re_notsafe);
        screamAppear();
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent=new Intent(RENotSafe.this, ReflexEscapeGame.class);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(RENotSafe.this, RENotSuccessful.class);
                startActivity(intent);
                overridePendingTransition(0,0);
                finish();
                REBGM.player.stop();
